      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Let&apos;s build something amazing together. Open to Software Engineer, Full-Stack Developer, and Mobile Developer roles.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <a href="mailto:dhirajshelke.hotmail@gmail.com" className="text-white/80 hover:text-white transition-colors">
              dhirajshelke.hotmail@gmail.com
            </a>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="https://www.linkedin.com/in/dhiraj-shelke-27b808201/" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors">
              LinkedIn
            </a>
          </div>
          <div className="flex items-center gap-3">
            ...
            <a href="https://github.com/Dhiraj455" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors">
              GitHub
            </a>
          </div>
        </motion.div>
...
Graduate Student at UIC | Passionate about Mobile Development, AI/ML, and Full-Stack Engineering
            ...
            <div className="flex items-center justify-center gap-4 text-[#FF6A3D] relative z-10">
              {/* GitHub */}
              <Link href="https://github.com/Dhiraj455" target="_blank" rel="noopener noreferrer" className="hover:text-[#E55A33] transition-colors" aria-label="GitHub">
              ...
              {/* LinkedIn */}
              <Link href="https://www.linkedin.com/in/dhiraj-shelke-27b808201/" target="_blank" rel="noopener noreferrer" className="hover:text-[#E55A33] transition-colors" aria-label="LinkedIn">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </Link>
              ...
              {/* Gmail */}
              <Link href="mailto:dhirajshelke.hotmail@gmail.com" className="hover:text-[#E55A33] transition-all hover:scale-110" aria-label="Gmail">
  ...
  Android development, scalable systems, and data-driven, user-centric products.
            ...
            >
              ...
              <div>
                <div className="text-3xl lg:text-4xl xl:text-5xl font-extrabold text-white mb-2">9.59</div>
                <div className="text-xs lg:text-sm text-white/60 leading-tight">UNDERGRAD<br/>CGPA</div>
              </div>
              <div>
                <div className="text-3xl lg:text-4xl xl:text-5xl font-extrabold text-white mb-2">10+</div>
                <div className="text-xs lg:text-sm text-white/60 leading-tight">PROJECTS<br/>BUILT</div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="font-semibold leading-tight text-lg lg:text-xl relative z-10">MOBILE DEVELOPMENT<br/>FULL-STACK<br/>AI/ML APPLICATIONS</div>
              </button>
              ...
              >
                ...
                <div className="font-semibold leading-tight text-lg lg:text-xl relative z-10">DATA-DRIVEN SYSTEMS<br/>
ANDROID • WEB • ML<br/>
BUILT FOR SCALE
</div>
              </button>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-white/70 max-w-3xl mx-auto">
                Pursuing advanced education in Computer Science with a focus on cutting-edge technologies and software engineering.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="text-center mb-6">
                  <div className="text-5xl font-extrabold text-white mb-2">9.59</div>
                  <div className="text-sm text-white/60">UNDERGRAD CGPA</div>
          ...
          <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-white/70 ml-2">MongoDB, PostgreSQL, MySQL, Redis, Firebase</span>
                  </div>
                  <div>
            ...
            >
              ...
              <p className="text-white/70 leading-relaxed mb-4">
                Development Head at CodeChef SIESGST, Technical Team Member at SIESGST. Winner of IDEATION &apos;22 National Idea Presentation Competition, 
                Regional Finalist in Smart India Hackathon 2023. Led teams in developing community platforms and technical solutions.
              </p>
              <div className="grid md:grid-cols-3 gap-4 text-center">
                <div className="p-4 bg-white/5 rounded-xl">
                  <div className="text-2xl font-bold text-white">Winner</div>
                  <div className="text-xs text-white/60">IDEATION &apos;22</div>
                </div>
                <div className="p-4 bg-white/5 rounded-xl">
                  <div className="text-2xl font-bold text-white">Finalist</div>
                  <div className="text-xs text-white/60">Smart India Hackathon</div>
                </div>
                <div className="p-4 bg-white/5 rounded-xl">
                  <div className="text-2xl font-bold text-white">Leader</div>
                  <div className="text-xs text-white/60">Development Head</div>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              >
                <div className="flex items-center justify-between mb-6">
                    <div>
                    <h3 className="text-2xl font-bold text-white mb-1">UIC College of Engineering</h3>
                    <p className="text-white/60 mb-1">Graduate Teaching Assistant</p>
                    <p className="text-white/50 text-sm">Chicago, IL • Jan 2025 - May 2025</p>
                        </div>
                        </div>
                <ul className="space-y-3 text-white/80 text-sm">
                  <li>• Assisted in CS 478: Mobile Application Development and CS 540: Advanced Topics in Software Engineering, supporting students with concepts and doubts</li>
                  <li>• Graded assignments and projects, ensuring timely and fair evaluation</li>
                  <li>• Supported students by clarifying concepts and providing guidance during office hours</li>
                </ul>
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="bg-blue-500/20 text-blue-200 px-2 py-1 rounded text-xs font-medium">Teaching</span>
                  <span className="bg-blue-500/20 text-blue-200 px-2 py-1 rounded text-xs font-medium">Mobile Development</span>
                  <span className="bg-blue-500/20 text-blue-200 px-2 py-1 rounded text-xs font-medium">Software Engineering</span>
                      </div>
              </motion.div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.4 }}
                className="rounded-3xl p-8 border border-white/20 bg-gradient-to-br from-orange-500/10 to-red-500/10"
              >
                <h4 className="text-xl font-bold mb-6 text-white">Previous Experience</h4>
...
<span className="bg-orange-500/20 text-orange-200 px-2 py-1 rounded text-xs font-medium">Typescript</span>
                  ...
                  {/* Help For Code */}
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        <h5 className="text-lg font-semibold text-white">Help For Code (HFC)</h5>
                        <p className="text-white/60 text-sm">Programmer Intern • Remote • January 2022 - April 2023</p>
                          </div>
                        </div>
                    <ul className="space-y-2 text-white/80 text-sm ml-4">
                      <li>• Developed programs in multiple programming languages, creating diverse code examples</li>
                      <li>• Authored numerous solved programming questions and challenges covering various languages and concepts</li>
                      <li>• Contributed to the internship website by providing high-quality programming content for educational purposes</li>
                      <li>• Contributed on the development of website to improve the UI</li>
                    </ul>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="bg-orange-500/20 text-orange-200 px-2 py-1 rounded text-xs font-medium">Programming</span>
                      <span className="bg-orange-500/20 text-orange-200 px-2 py-1 rounded text-xs font-medium">Web Development</span>
                      <span className="bg-orange-500/20 text-orange-200 px-2 py-1 rounded text-xs font-medium">Content Creation</span>
                    </div>
                        </div>
                  ...
                  {/* SIES GST */}
                    ...
                    <div className="flex items-center justify-between mb-3">
                    <div>
                        <h5 className="text-lg font-semibold text-white">SIES GST</h5>
                        <p className="text-white/60 text-sm">Web Developer Intern • Remote • July 2022 - May 2023</p>
                    </div>
                  </div>
                    <ul className="space-y-2 text-white/80 text-sm ml-4">
                      <li>• Developed a website application to spread information about campus events and encourage community among college students with features like announcements, shared notes, blogs, and a forum for interaction between alumni and students</li>
                      <li>• Led a team of people in enhancing the website&apos;s structure, speed, and accuracy</li>
                    </ul>
                    <div className="mt-3 flex flex-wrap gap-2">
...
<span className="bg-orange-500/20 text-orange-200 px-2 py-1 rounded text-xs font-medium">Typescript</span>
            ...
            <motion.div
              ...
              className="mt-12"
            >
              <h3 className="text-2xl font-bold mb-8 text-white text-center">PROJECTS</h3>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  href="https://github.com/Dhiraj455" 
                  target="_blank" 
                ...
                <Link 
                  href="https://www.linkedin.com/in/dhiraj-shelke-27b808201/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[var(--accent)]/20 hover:text-[var(--accent)] transition-all duration-300 text-white/70 group"
                  title="LinkedIn"
              ...
              <div className="text-center md:text-right">
                <p className="text-white/50 text-sm mb-1">© 2025 Dhiraj Shelke</p>
